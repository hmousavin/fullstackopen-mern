...
const Menu = () => {
  ...
  return (
    <div>
      ...
      <div>
        <Link style={paddingStyle} to="/">anecdotes</Link>
        <Link style={paddingStyle} to="/create">create new</Link>
        <Link style={paddingStyle} to="/about">about</Link>
      </div>
    </div>
  )
}
...
const ShowAnecdote = ({props}) => {
  return (
    <div>
      ...
      <p>for more info see {props.info}</p>
    </div>
  )
}
...
const Notification = (props) => {
  return (
    // <p>{props}</p>
    <div><strong>{props.notification}</strong></div>
  )
}
  ...
  return (
    <div>
      ...
      <Routes>
        ...
        <Route path='/anecdotes/:id'  element={<ShowAnecdote props={selectedAnecdote} />}></Route>
      </Routes>
      <Footer />
    </div>
  )
